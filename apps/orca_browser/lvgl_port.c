// src/ui/lvgl_port.c ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â LVGL v9.3 display port for FreeWili2 (RP2350B) + ST7796.
//
// Buffer sizing note:
...
//   lv_display_flush_ready() ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â calling it in flush_cb() would corrupt the
//   handshake.
#include "lvgl_port.h"
...
#define HOR       480
#define VER       320
/* 10 lines per buffer: 2 ÃƒÆ’Ã¢â‚¬â€ 10 ÃƒÆ’Ã¢â‚¬â€ 480 ÃƒÆ’Ã¢â‚¬â€ 2 B = 19 200 B total. Trimmed from 20 to
   ...
   through these buffers ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 10 lines is ample. */
#define BUF_LINES 10
...
/* Global display handle ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â needed by the ISR callback. */
...
/* ---- LVGL log callback ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ RTT ---- */
...
static void flush_cb(lv_display_t *disp, const lv_area_t *area, uint8_t *px_map)
{
    ...
    /* DO NOT call lv_display_flush_ready() here ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the DMA IRQ does it. */
}
